...
class FacesClassificator:
    def __init__(self, **kwargs):
        ...
        self._input_height = getattr(kwargs, 'input_height', 128)
        self._input_width = getattr(kwargs, 'input_width', 128)
        self._input_mean = getattr(kwargs, 'input_mean', 128)
        self._input_std = getattr(kwargs, 'input_std', 128)
        self._input_layer = getattr(kwargs, 'input_layer', 'input') # If we use inception_v3, put there "Mul"
